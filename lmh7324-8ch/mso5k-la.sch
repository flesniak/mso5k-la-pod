...
U 1 1 5C408E07
P 2400 2100
F 0 "#PWR0114" H 2400 1950 50  0001 C CNN
F 1 "+2V5" V 2415 2228 50  0000 L CNN
...
F 1 "+4V" V 2415 2328 50  0000 L CNN
...
Wire Wire Line
	2250 3750 2400 3750
$Sheet
S 3200 3100 550  1300
U 5C4C51E0
F0 "Ch 4-7" 50
F1 "quad.sch" 50
F2 "InA" I L 3200 3300 50 
F3 "InB" I L 3200 3550 50 
F4 "InC" I L 3200 3800 50 
F5 "InD" I L 3200 4050 50 
F6 "Vref" I L 3200 4250 50 
F7 "OutA+" O R 3750 3250 50 
F8 "OutA-" O R 3750 3350 50 
F9 "OutB+" O R 3750 3500 50 
F10 "OutB-" O R 3750 3600 50 
F11 "OutC+" O R 3750 3750 50 
F12 "OutC-" O R 3750 3850 50 
F13 "OutD+" O R 3750 4000 50 
F14 "OutD-" O R 3750 4100 50 
$EndSheet
...
U 1 1 5C6055FB
P 3650 2100
F 0 "#PWR0117" H 3650 1850 50  0001 C CNN
...
F 0 "C101" H 5315 1846 50  0000 L CNN
F 1 "10uF" H 5315 1755 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric" H 5238 1650 50  0001 C CNN
...
F 0 "C102" H 5715 1846 50  0000 L CNN
F 1 "10uF" H 5715 1755 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric" H 5638 1650 50  0001 C CNN
...
F 0 "C103" H 6115 1846 50  0000 L CNN
F 1 "10uF" H 6115 1755 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric" H 6038 1650 50  0001 C CNN
...
F 0 "#PWR0119" H 5200 1750 50  0001 C CNN
...
F 0 "#PWR0121" H 5600 1750 50  0001 C CNN
...
F 0 "#PWR0123" H 6000 1750 50  0001 C CNN
...
F 1 "+4V" H 5215 1723 50  0000 C CNN
...
F 0 "#PWR0120" H 5600 1400 50  0001 C CNN
F 1 "+2V5" H 5615 1723 50  0000 C CNN
...
F 1 "-2V5" H 6015 1723 50  0000 C CNN
...
F 0 "C104" H 6350 1850 50  0000 L CNN
F 1 "100n" H 6350 1650 50  0000 L CNN
...
F 0 "#PWR0124" H 6550 1750 50  0001 C CNN
...
Wire Wire Line
	6550 2000 6550 1900
$Sheet
S 1700 3100 550  1300
U 5C4819A8
F0 "Ch 0-3" 50
F1 "quad.sch" 50
F2 "InA" I L 1700 3300 50 
F3 "InB" I L 1700 3550 50 
F4 "InC" I L 1700 3800 50 
F5 "InD" I L 1700 4050 50 
F6 "Vref" I L 1700 4250 50 
F7 "OutA+" O R 2250 3250 50 
F8 "OutA-" O R 2250 3350 50 
F9 "OutB+" O R 2250 3500 50 
F10 "OutB-" O R 2250 3600 50 
F11 "OutC+" O R 2250 3750 50 
F12 "OutC-" O R 2250 3850 50 
F13 "OutD+" O R 2250 4000 50 
F14 "OutD-" O R 2250 4100 50 
$EndSheet
$Comp
L Connector_Generic:Conn_02x08_Odd_Even J102
U 1 1 5C4D4EB6
P 4050 1600
F 0 "J102" H 4100 2117 50  0000 C CNN
F 1 "in" H 4100 2026 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_2x08_P2.54mm_Vertical" H 4050 1600 50  0001 C CNN
...
U 1 1 5C536BEA
P 1950 1800
F 0 "J101" H 2000 2617 50  0000 C CNN
F 1 "out" H 2000 2526 50  0000 C CNN
F 2 "Connector_PinHeader_1.27mm:PinHeader_2x13_P1.27mm_Vertical_SMD" H 1950 1800 50  0001 C CNN
...
U 1 1 5C604024
P 5200 2600
F 0 "J103" V 5140 2512 50  0000 R CNN
F 1 "3mm" V 5049 2512 50  0000 R CNN
F 2 "projectdir:3mm" H 5200 2600 50  0001 C CNN
...
U 1 1 5C606E4D
P 5550 2600
F 0 "J104" V 5490 2512 50  0000 R CNN
F 1 "3mm" V 5399 2512 50  0000 R CNN
F 2 "projectdir:3mm" H 5550 2600 50  0001 C CNN
...
U 1 1 5C609B9F
P 5950 2600
F 0 "J105" V 5890 2512 50  0000 R CNN
F 1 "3mm" V 5799 2512 50  0000 R CNN
F 2 "projectdir:3mm" H 5950 2600 50  0001 C CNN
...
U 1 1 5C609BAC
P 6300 2600
F 0 "J106" V 6240 2512 50  0000 R CNN
F 1 "3mm" V 6149 2512 50  0000 R CNN
F 2 "projectdir:3mm" H 6300 2600 50  0001 C CNN
...
F0 "LEDs" 50
F1 "leds.sch" 50
F2 "Vcc" I L 5300 3800 50 
F3 "Vee" I L 5300 4200 50 
F4 "Vref" I L 5300 4000 50 
$EndSheet
...
U 1 1 5C64EFB5
P 5150 3800
AR Path="/5C64EFB5" Ref="#PWR0113"  Part="1" 
AR Path="/5C4819A8/5C64EFB5" Ref="#PWR?"  Part="1" 
AR Path="/5C4C51E0/5C64EFB5" Ref="#PWR?"  Part="1" 
AR Path="/5C4E887D/5C64EFB5" Ref="#PWR?"  Part="1" 
AR Path="/5C4EBCE6/5C64EFB5" Ref="#PWR?"  Part="1" 
F 0 "#PWR0113" H 5150 3650 50  0001 C CNN
F 1 "+2V5" H 5165 3973 50  0000 C CNN
...
U 1 1 5C64EFF2
P 5150 4200
AR Path="/5C64EFF2" Ref="#PWR0115"  Part="1" 
AR Path="/5C4819A8/5C64EFF2" Ref="#PWR?"  Part="1" 
AR Path="/5C4C51E0/5C64EFF2" Ref="#PWR?"  Part="1" 
AR Path="/5C4E887D/5C64EFF2" Ref="#PWR?"  Part="1" 
AR Path="/5C4EBCE6/5C64EFF2" Ref="#PWR?"  Part="1" 
F 0 "#PWR0115" H 5150 4300 50  0001 C CNN
F 1 "-2V5" H 5165 4373 50  0000 C CNN
...
F 1 "+2V5" V 1565 2228 50  0000 L CNN
...
U 1 1 5C52E342
P 1550 2200
F 0 "#PWR0105" H 1550 2050 50  0001 C CNN
F 1 "+4V" V 1565 2328 50  0000 L CNN
